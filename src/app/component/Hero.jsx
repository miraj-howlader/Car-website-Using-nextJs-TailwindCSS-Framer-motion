        ...
        <div className=" flex flex-col xl:flex-row justify-center items-center
         xl:justify-start h-full">
          ...
          <div className=" text-center xl:max-w-xl xl:text-left mt-16
           xl:mt-0">
            ...
            <motion.p
             ...
             whileInView={'show'}
             viewport={{once:false, amount:0.6}}
             className=" description max-w-[550px] mx-auto
             xl:mx-0 mb-6">
            ...
            <motion.div
             ...
             className=" mt-4 flex gap-x-3 justify-center
             xl:justify-start">
          ...
          <motion.div
           ...
           md:max-w-[70vw] xl:max-w-[660px] xl:max-h-[542px]
            xl:absolute xl:right-[90px] min-[1680px]
             right-[120px] xl:top-30">
            <Image src={'/images/hero/car.svg'} fill alt=""
