...
const Cta = () => {
  return (
    <section
      className="pt-24 xl:pt-48 flex  items-center pb-0
           ...
           mb-12 md:mb-0">
            <div className=" max-w-[520px] mx-auto order-2 xl:order-none">
              ...
              <motion.p
                ...
                whileInView={'show'}
                viewport={{once:false, amount:0.6}}
               className=" mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat culpa libero ut consequuntur nulla. Enim odio harum facilis incidunt perferendis?</motion.p>
             {/* btn  */}
             <motion.div
